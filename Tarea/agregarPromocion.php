...
$sentencia_promocion = $bd->prepare("select * from promociones where id_producto = ?;");
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-header">
                    Ingresar datos para Promocion : <br><?php echo $producto->nombre.' '.$producto->descripcion; ?>
                </div>
