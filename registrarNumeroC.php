...
<div class="container mt-5">
    <div class="row justify-content-center">
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a onclick="return confirm('Estas seguro de eliminar?');" class="text-danger" href="eliminarC.php?codigo=<?php echo $dato->id; ?>"><i class="bi bi-trash"></i></a></td>
                            </tr>
        ...
        <div class="col-md-4">
            <a href="index.php"><input type="submit" class="btn btn-success" value="Registrar Producto" ></a>
            <div class="card">
                <div class="card-header">
                    Ingresar datos:
                </div>
                <form class="p-4" method="POST" action="registrarC.php">
                    <div class="mb-3">
